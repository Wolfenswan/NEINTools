    ...
    public abstract class SerializableDictionaryDrawer<TK, TV> : PropertyDrawer
    {
        ...
        private static readonly Dictionary<Type, Func<Rect, object, object>> _Fields =
            new Dictionary<Type,Func<Rect,object,object>>()
            {
                ...
                // Custom additions - Markus
                { typeof(Color), (rect, value) => EditorGUI.ColorField(rect, (Color)value) },
                { typeof(Color32), (rect, value) => EditorGUI.ColorField(rect, (Color32)value) },
                { typeof(Enum), (rect, value) => EditorGUI.EnumFlagsField(rect, (Enum)value) },
            };
