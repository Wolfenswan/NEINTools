...
/* REGISTERING WITH DEBUG-MANAGER
Without text-field:
...
namespace NEINGames.Debugging 
{
    ...
    {   
        ...
        void RegisterObjectWithDebugManager(); // Easiest implement as => DebugManager.Instance.RegisterObject<TYPE>(this, $"{this}", _dbgMaxLogLevel);
    }
}